...
import 6th_lesson.Person.genderTypes;

public class 6th_lessons_task {
    ...
    public static void main(String[] args) {
        ...
        // Здесь мы объединяем два дубликата экземпляра класса Person (если в каком то из экземпляров класса есть недостающее свойтсво)
